      ...
      >
        ...
        <div className=" mx-0 top-0 text-center overflow-hidden z-20 pt-5  ">
          ...
          <p className="p-3 pb-0 text-sm text-left ">
            Early-tur med sykkel ut til Skeisnesset for å spise frokost,
            fotografering etc. Vandretur ut til nordenden av Leka, blant
            kystlynghei, gravhauger, fugler og villsau for å se på morgensolen
            stå opp. Frokost og morgensol i fredfulle omgivelser, for oss som
            ønsker en ekstra vakker start på dagen.{" "}
          </p>
          <p className="text-sm text-left p-3">
            Turen er godt egnet til morgenyoga, meditasjon eller foto- og
            diktinspirasjon.
          </p>
