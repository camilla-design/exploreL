  ...
  return (
    <div>
        ...
        transition={{
         ...
         <h1 className='text-5xl uppercase font-bold tracking-[2px] text-[#ffa500] w-[300px] md:w-full '>Explore<br></br> <span className='font-bold text-3xl text-black'>Leka med oss</span> </h1>
