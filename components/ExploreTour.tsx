...
export default function ExploreTour({}: Props) {
  return (
    ...
    <div className='relative bg-[#ffa500] w-[100px] p-2 rounded-md'>
      ...
      <p className="p-3 pb-0 text-sm text-left ">Vandrer inn mot jordens indre og tråkker på 500 millioner år gamle bergarter, innover på biter av det Amerikanske kontinentet. Til Nordtjønna hvor vi spiser et godt måltid før vi tar turen videre opp til Utsikten. Ned til Nesvatnet, utover Lekafjorden med Heilhornene majestetisk bak. Vi ser skipsleia Nordover forbi Torghatten, Vega og de syv søstre. Så ned til Møsmørklubban og bortover til Moho. Krever god balanse og sterke ankler i et magisk, unikt og lunefullt landskap. </p>
